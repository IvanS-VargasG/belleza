     ...
     <!-- Tabla Dinamica -->
      ...
      <td><p><?php echo $fila['apellidom'] ?></p></td>
       ...
       <td><?php echo "<a href=\"edus.php?id=".$fila['id']."\">"; ?><input type="button" name="edi" value="Editar"></a></td>
	 		<td><?php echo "<a href=\"elmuser.php?id=".$fila['id']."\">"; ?>
             <?php if ($fila['id']== $varid) { ?>
                <input type="submit" id="dis" value="Borrar" disabled="true">
             <?php }else { ?>
                <input type="button" name="eliminar" value="Borrar">
            <?php } ?>
             </a></td>
	 	</tr>
	 	<?php
